 ...
 ░░█████████  ░░███████  ████████ ░░██████  █████    ░░█████████  █████  █████      ░░█████ 
  ░░░░░░░░░    ░░░░░███ ░░░░░░░░   ░░░░░░  ░░░░░      ░░░░░░░░░  ░░░░░  ░░░░░        ░░░░░  
    ...
    def subdomain_enumeration(self):
        ...
        amass_cmd = f"amass enum -passive -d {self.target} -o {os.path.join(self.output_dir, amass_file)} -silent"
    ...
    def ffuf_enumeration(self):
        ...
        # Run ffuf in normal mode without filtering
        ffuf_cmd = (
    ...
    def run(self):
        """Execute the Nmap, Subfinder, Amass, Sublist3r, Dirb, ffuf, and Nuclei scan workflow."""
        self.print_banner()
...
def main():
    parser = argparse.ArgumentParser(description="CyberSift: Nmap, Subfinder, Amass, Sublist3r, Dirb, ffuf, and Nuclei Scanner")
